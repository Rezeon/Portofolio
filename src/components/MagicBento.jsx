...
const cardData = [
  {
    color: "#060010",
    label: "Web Dev",
    description: `I have experience in Full-Stack Development, specializing in React.js, Vue.js, Laravel, and Express.js. 
  ...
  },
  {
    ...
    description: `I analyze and visualize data using Python, R, and SQL, along with Pandas, NumPy, Matplotlib, and scikit-learn. 
  ...
  },
  {
    ...
    description: `I design precise 2D/3D product models with AutoCAD, SolidWorks, and Autodesk, creating technical drawings for prototyping and manufacturing.`,
    label: "3D Modeling",
  },
];
  ...
  return (
    <>
      ...
      <BentoCardGrid gridRef={gridRef}>
        <div className="card-responsive flex flex-col gap-2">
